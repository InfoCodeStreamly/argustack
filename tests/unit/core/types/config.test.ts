...
const ALL_SOURCE_TYPES: SourceType[] = ['jira', 'git', 'github', 'csv', 'db', 'board', 'code'];
...
describe('core/types/config module', () => {
  ...
  describe('ALL_SOURCES', () => {
    ...
    it('matches exact values in exact order: jira, csv, git, github, db, board, code', () => {
      expect(ALL_SOURCES).toEqual(['jira', 'csv', 'git', 'github', 'db', 'board', 'code']);
    });
